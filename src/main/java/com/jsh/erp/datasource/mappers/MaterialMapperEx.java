...
import com.jsh.erp.datasource.entities.MaterialOutVo4Unit;
...
public interface MaterialMapperEx {
    ...
    //2022-04-17
    List<MaterialOutVo4Unit> findBySelectOutWithBarCode(@Param("idList") List<Long> idList,
                                                        @Param("q") String q,
                                                        @Param("offset") Integer offset,
                                                        @Param("rows") Integer rows);
    ...
    //2022-04-17
    int findBySelectOutWithBarCodeCount(@Param("idList") List<Long> idList,
                                     @Param("q") String q);
