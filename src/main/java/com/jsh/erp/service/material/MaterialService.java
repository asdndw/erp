...
public class MaterialService {
    ...
    public List<MaterialOutVo4Unit> findBySelectOutWithBarCode(Long categoryId, String q, Integer offset, Integer rows)throws Exception{
        List<MaterialOutVo4Unit> list =null;
        try{
            List<Long> idList = new ArrayList<>();
            if(categoryId!=null){
                Long parentId = categoryId;
            ...
            list=  materialMapperEx.findBySelectOutWithBarCode(idList, q, offset, rows);
        }catch(Exception e){
            JshException.readFail(logger, e);
        }
        return list;
    ...
    //2022-04-17
    public int findBySelectOutWithBarCodeCount(Long categoryId, String q)throws Exception{
        int result=0;
        try{
            List<Long> idList = new ArrayList<>();
            if(categoryId!=null){
            ...
            result = materialMapperEx.findBySelectOutWithBarCodeCount(idList, q);
        }catch(Exception e){
            logger.error("异常码[{}],异常提示[{}],异常[{}]",
                    ExceptionConstants.DATA_READ_FAIL_CODE,ExceptionConstants.DATA_READ_FAIL_MSG,e);
            throw new BusinessRunTimeException(ExceptionConstants.DATA_READ_FAIL_CODE,
